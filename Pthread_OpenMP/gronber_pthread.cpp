...
int main()
{
    ...
    timespec_get(&start, TIME_UTC);//开始计时
    ...
    timespec_get(&end1, TIME_UTC);//结束计时
    ...
    printf("Time of gronber+SIMD+pthread-example7 : %lld.%09lds\n", total_duration_sec, total_duration_nsec);
}
